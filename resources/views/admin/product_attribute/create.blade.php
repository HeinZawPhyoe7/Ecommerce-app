            ...
            <div class=" card">
                ...
                <div class=" card-body">
                    ...
                    <form action="{{ route('attribute.create') }}" method="POST">
                        @csrf
                        <label for="attribute_value" class=" fw-bold mb-2">Give Name of Your Attributes</label>
                        <input type="text" class="form-control" name="attribute_value" placeholder="Xl">

                        <button type="submit" class=" btn btn-primary w-100 mt-2">Add Attributes</button>
                    </form>
                </div>
            </div>
        </div>
